package com.mooStan.mycarskids;
...
import com.mooStan.mycarskids.R;
...
public class Cars2Throw extends Activity implements OnGestureListener {
...
public static final String PREFS_NAME = "YunizMtSaves";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cars2_throw);
		...
		txtNo1.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick1.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore1.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo2.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick2.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore2.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo3.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick3.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore3.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo4.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick4.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore4.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo5.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick5.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore5.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo6.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick6.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore6.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo7.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick7.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore7.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo8.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick8.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore8.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo9.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick9.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore9.setTextColor(Color.parseColor("#FFFFFF"));
		txtNo10.setTextColor(Color.parseColor("#FFFFFF"));
		txtNick10.setTextColor(Color.parseColor("#FFFFFF"));
		txtScore10.setTextColor(Color.parseColor("#FFFFFF"));
...
public void initTitans(ImageView titanSelect, int locations){
	...
	public void reFreshMinions(){
		String minionGIF = "minion_" + generateNumber(1,12) + ".png";
	...
	public void gameScoreSubmitAPI(String nickname, int scores){
		...
		String url = "http://www.yuniz.com/apps/c2t/?mod=1&nickname=" + nickname + "&score=" + scores;
		//-------load JSON
	...
	public void gameScoresAPI(String pages){
		String url = "http://www.yuniz.com/apps/c2t/?mod=2&page=" + pages;
		//-------load JSON
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
        //nameValuePairs.add(new BasicNameValuePair("convo_id", "4546db1fd1"));
        //nameValuePairs.add(new BasicNameValuePair("say", words));
